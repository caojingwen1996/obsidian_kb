...
Write each recommendation with a concrete reason: *"[[concepts/attention-mechanism|attention-mechanism]] — your foundational page; three new papers ingested this week all extend it"*, not just the page title.
