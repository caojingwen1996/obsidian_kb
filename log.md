...
- 资料依据：[[wiki/concepts/冰冰小美-framework-金融信息归纳框架|金融信息归纳框架]] 当前正文及用户本次改造要求。
...
- 资料依据：用户本轮五层归纳要求及 [[wiki/concepts/冰冰小美-framework-金融信息归纳框架|金融信息归纳框架]] 最新正文；结构化字段为实现约定，不作作者原话。
