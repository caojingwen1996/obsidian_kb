...
按用户要求抓取雪球帖子中的网页链接，并整理到风险相关页面。该帖为投资相声口儿整理的冰冰小美宏观风险关键词文章索引，正文共抓取到 40 个冰冰小美链接，分为全球局势/宏观风险、石油危机、恶性通胀、军事冲突四组。本次先将索引帖归档为 source，再补入 [[topics/冰冰小美-风险提示系列|风险提示系列]]、[[冰冰小美-trigger-宏观信号表|宏观风险信号表]] 和 [[冰冰小美-风险节点记录|风险节点记录]]。
