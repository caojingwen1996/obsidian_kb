...
在 [[topics/冰冰小美-情绪体系理论篇|体系三要素]] 中，本概念负责回答“方向有没有资格”。它不直接回答资金是否承接，也不直接回答情绪是否合力；后两项分别由 [[冰冰小美-concept-流动性辩证分析|流动性辩证分析]] 与 [[concepts/冰冰小美-concept-情绪位置的变化|情绪位置的变化]] 校验。
