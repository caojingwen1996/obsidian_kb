# 持仓每日监控证据与执行记录（2026-09-18）

- 截止：2026-09-18 10:09:47 CST；行情仅截至2026-09-17收盘；今日盘中价未使用。
- 配置：动态17只（6持有、11观察），较上一运行新增三一重工。
- 权威基线：按证券代码筛选artifact_type=equity_research且非归档，17只均唯一；旧日期转发页不是权威研报。路径、版本、哈希与行情原始行见[数据快照](../../../sources/automations/持仓每日监控/2026-09-18/current-run-evidence.json)。
- 失败与恢复：Tushare通过仅对api.tushare.pro直连的进程成功取得17只行情；东材科技公告原文已保存、抽取文本并做哈希核验。
- 公告：17家公司公开公告索引逐一检查；本轮相关正式材料已下载核验。索引可能延迟，未检出不等于无公告保证。
- 本轮新增保存并核验1份东材科技法定公告原文；中国船舶提级调查材料沿用库内副本并再次在线复核。公告时间与事件时间在逐股第3节分列。
...
- 复盘7项：4项量价/区间异常、云铝与船舶2项人工估值复核，另保留紫光现金估值分歧，另保留紫光股份原报告现金估值分歧为复盘，不计为新异常或新增重估队列。
- 专项验证通过：36份母稿/HTML同源、链接、8节、10项必查输入、4项KPI、H1-H3、动态清单、权威文件哈希、失败队列和看板映射。Node全量测试110/117通过，7项既有范围外失败为侧栏顺序、三要素摘要、市场概览、产业表布局、主题地图、盘中刷新、旧徐工转发页六章格式；本轮没有改动相关源码/测试或权威研报。看板build成功，不代表全量回归成功。
...
- 601766 中国中车：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/601766.phtml)，最新列示2026-09-17；基线中国中车-机构级决策研报.md，模型4.5.0，估值基准2026-09-09。
...
- 601208 东材科技：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/601208.phtml)，最新列示2026-09-18；基线2026-07-17-1450-东材科技-机构级决策研报.md，模型4.4.2，估值基准2026-09-08。
