# 持仓每日监控证据与执行记录（2026-09-17）

- 截止：2026-09-17 10:08:34 CST；行情仅截至2026-09-16收盘；今日盘中价未使用。
- 配置：动态17只（6持有、11观察），较上一运行新增三一重工。
- 权威基线：按证券代码筛选artifact_type=equity_research且非归档，17只均唯一；旧日期转发页不是权威研报。路径、版本、哈希与行情原始行见[数据快照](../../../sources/automations/持仓每日监控/2026-09-17/current-run-evidence.json)。
- 失败与恢复：Tushare通过仅对api.tushare.pro直连的进程成功取得17只行情；三一重工两份PDF已保存、抽取文本并做哈希核验。
- 公告：17家公司公开公告索引逐一检查；本轮相关正式材料已下载核验。索引可能延迟，未检出不等于无公告保证。
- 本轮保存并核验2份三一重工正式公告；中国船舶提级调查材料沿用9月16日库内副本并再次在线复核。公告时间与事件时间在逐股第3节分列。
...
- 复盘8项：5项量价/区间异常、云铝与船舶2项人工估值复核，另保留紫光股份原报告现金估值分歧为复盘，不计为新异常或新增重估队列。
- 专项验证通过：36份母稿/HTML同源、链接、8节、10项必查输入、4项KPI、H1-H3、动态清单、权威文件哈希、失败队列和看板映射。信息归纳契约测试6/6、Python看板测试75/75通过；Node全量105/112通过，7项既有范围外失败仍为侧栏顺序、三要素摘要、市场概览、产业表布局、主题地图、盘中刷新、旧徐工转发页六章格式；本轮没有改动相关源码/测试或权威研报。看板build成功，不代表全量回归成功。
...
- 000426 兴业银锡：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/000426.phtml)，最新列示2026-09-15；基线兴业银锡-机构级决策研报.md，模型4.4.2，估值基准2026-09-09。
- 601168 西部矿业：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/601168.phtml)，最新列示2026-09-02；基线西部矿业-机构级决策研报.md，模型4.4.2，估值基准2026-09-09。
...
- 600938 中国海油：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/600938.phtml)，最新列示2026-09-12；基线中国海油-机构级决策研报.md，模型4.4.2，估值基准2026-09-09。
...
- 601919 中远海控：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/601919.phtml)，最新列示2026-09-17；基线2026-09-08-1715-中远海控-机构级决策研报.md，模型4.4.2，估值基准2026-09-08。
...
- 600031 三一重工：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/600031.phtml)，最新列示2026-09-17；基线2026-07-24-0931-三一重工-机构级决策研报.md，模型4.4.2，估值基准2026-09-08。
