# 持仓每日监控证据与执行记录（2026-09-14）

- 截止：2026-09-14 10:36:49 CST；行情仅截至2026-09-11收盘；本周尚无已完成交易日。
- 配置：动态17只（6持有、11观察），较上一轮新增华能国际。
- 权威基线：按证券代码筛选artifact_type=equity_research且非归档，17只均唯一；旧日期转发页不是权威研报。路径、版本、哈希与行情原始行见[数据快照](../../../sources/automations/持仓每日监控/2026-09-14/current-run-evidence.json)。
- 失败与恢复：Tushare首次通过127.0.0.1:7892代理超时；仅该进程对api.tushare.pro直连后成功。华润江中上交所PDF下载返回非PDF，改用公告原文镜像；国务院官网正文返回403，使用新华社在证券时报的转载并与政府网索引交叉核对。
- 公告：17家公司索引逐一检查；华润江中新浪索引曾只到9月3日，已用正式9月11日澳门注册公告及搜狐索引补核。未检出不等于无公告保证。
- 实际新增披露4份：神马电力减持结果、中国海油管理层调整、华能国际两笔融资；另补存华润江中旧分红方案用于除息核验。公告时间与事件时间在逐股第3节分列，旧船舶事故及澳门注册不重复计为新增事件。
...
- [新华财经9月11日商品收盘](https://www.cnfin.com/dz-lb/detail/20260911/4468864_1.html)：银锡铜铝与原油的单日变化，不能替代正常化长期价格假设。
- [长江9月11日现货铜报价](https://news.ccmn.cn/news/ZX018/202609/0324ffddbf1244e1af02d0b5050a9f5d.html)：公司实现售价、权益产量与成本另需验证。
...
- 17份逐股Markdown与同源HTML，1份汇总Markdown与HTML；11项输入核查（含要求的10项及定期报告），4项经营/财务KPI，H1—H3映射。
- 华润江中9月11日派0.50元：日涨跌幅使用除息参考价22.61元，近5日连乘交易所日涨跌幅；另列税前总回报代理，原不复权比不冒充经济亏损。旧含息区间只作标注后的参考。
- 所有来源、关键事实与模型假设分离；未提供成本仓位，不生成账户盈亏或买卖指令。
- 复盘7项：6项量价/区间或事故异常，另保留紫光股份原报告现金估值分歧为复盘，不计为新异常或新增重估队列。
- 专项验证通过：36份母稿/HTML同源、链接、8节、10项必查输入、4项KPI、H1-H3、动态清单、权威文件哈希、失败队列和看板映射。Node全量96/103，7项范围外失败：侧栏顺序、三要素摘要、市场概览、产业表布局、主题地图、盘中刷新、旧徐工转发页六章格式；本轮没有改动相关源码/测试或权威研报。看板build成功，不代表全量回归成功。

- 002270 华明装备：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/002270.phtml)，最新列示2026-09-03；基线2026-07-30-华明装备-机构级决策研报.md，模型4.4.2，估值基准2026-09-08。
...
- 000426 兴业银锡：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/000426.phtml)，最新列示2026-09-08；基线兴业银锡-机构级决策研报.md，模型4.4.2，估值基准2026-09-08。
...
- 000938 紫光股份：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/000938.phtml)，最新列示2026-09-08；基线2026-08-03-1638-紫光股份-机构级决策研报.md，模型4.4.3，估值基准2026-09-09。
...
- 600011 华能国际：[公告索引](https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/600011.phtml)，最新列示2026-09-11；基线华能国际-机构级决策研报.md，模型4.5.0，估值基准2026-09-10。
