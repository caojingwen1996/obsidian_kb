...
assert.match(reportTemplate, /具体风险类型＋方向＋时间化证据＋主要反证/);
assert.match(reportTemplate, /不得只写“风险重新增强”等总标签/);
...
assert.match(html, /估值兑现风险和反弹承接风险重新增强；杠杆风险减弱/);
